...
public class SceneFade : MonoBehaviour
{
    ...
    public IEnumerator FadeOutCoroutine(float duration) 
        {
            Color targetColour = new Color(_sceneFadeImage.color.r, _sceneFadeImage.color.g, _sceneFadeImage.color.b, 0);
            Color startColor = new Color(_sceneFadeImage.color.r, _sceneFadeImage.color.g, _sceneFadeImage.color.b, 0);

            gameObject.SetActive(true);
            yield return FadeCoroutine(startColor, targetColour, duration);
         }
